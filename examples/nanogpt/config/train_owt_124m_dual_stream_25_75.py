# OpenWebText with Convex Dual Stream (124M parameters) - 0.25/0.75 weights
# GPT-2 base architecture with dual stream (0.25 pre-LN, 0.75 post-LN)

wandb_log = True
wandb_project = "nanogpt-mhc"
wandb_run_name = "gpt2-124M-dual-stream-25-75"

out_dir = "out-owt-124m-dual-stream-25-75"
dataset = "openwebtext"
