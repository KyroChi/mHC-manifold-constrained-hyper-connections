# OpenWebText with Convex Dual Stream (124M parameters) - 0.90/0.10 weights
# GPT-2 base architecture with dual stream (0.90 pre-LN, 0.10 post-LN)

wandb_log = True
wandb_project = "nanogpt-mhc"
wandb_run_name = "gpt2-124M-dual-stream-90-10"

out_dir = "out-owt-124m-dual-stream-90-10"
dataset = "openwebtext"
